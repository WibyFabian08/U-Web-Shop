...
import { NavigationBar, ListKategori, ListMenu } from '../Component/Shop';
...
class Home extends React.Component {
  ...
  render() {
    return (
      <Container>
        <NavigationBar dataKeranjang={this.state.dataKeranjang} getListKeranjang={this.getListKeranjang} {...this.props}></NavigationBar>
        <Row>
